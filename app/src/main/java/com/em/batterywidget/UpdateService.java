...
public class UpdateService extends IntentService {
    ...
    public void sendSimpleNotification(int level) {
        //Bu method basit bir bildirim gösterecektir. Çalıştırayım mı . çalıştır bi bakalım.
        Intent resultIntent = new Intent(this, WidgetActivity.class);
        ...
        NotificationCompat.Builder mBuilder =
                new NotificationCompat.Builder(this)
                        .setSmallIcon(R.drawable.batarya)
                        .setContentTitle("Pil Seviyesi")
